...
In order to use these nodes, you must have an account with imgBB service. Once you have your account, navigate to https://api.imgbb.com/ and generate an API key. You will need to configure this key in the *imgbb_api_key.json* file in the nodes subfolder `./loaders/`. 
